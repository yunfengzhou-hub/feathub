...
public class PrometheusConfigs {
    ...
    public static final ConfigOption<String> EXTRA_LABELS =
            ConfigOptions.key("extraLabels")
                    ...
                    .defaultValue("")
                    .withDescription(
                            "The extra labels of all the metrics. The label name and value are separated"
                                    + " by '=', and labels are separated by ';', e.g., k1=v1;k2=v2. Please "
                                    + "ensure that your grouping key meets the Prometheus requirements.");
}
