...
class FlinkSqlFeatureViewITTest(ABC, FeathubITTestBase):
    def setUp(self) -> None:
        ...
        self.source = self.create_file_source(
            self.input_data.copy(), name="__TEST_SOURCE__"
        )
    ...
    def tearDown(self) -> None:
        ...
        typing.cast(LocalRegistry, self.client.registry).tables.clear()
