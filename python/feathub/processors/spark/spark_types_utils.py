...
def to_spark_schema(schema: Schema) -> native_spark_types.StructType:
    """
    Convert Feathub schema to native Spark schema.

    :param schema: The Feathub schema.
    :return: The native Spark schema.
    """
...
def to_feathub_schema(schema: native_spark_types.StructType) -> Schema:
    """
    Convert Spark TableSchema to Feathub schema.

    :param schema: The Spark TableSchema.
...
def to_feathub_type(spark_type: native_spark_types.DataType) -> types.DType:
    """
    Convert Spark native_spark_types.DataType to Feathub types.DType.

    :param spark_type: The Spark native_spark_types.DataType.
    :return: The Feathub types.DType.
    """
