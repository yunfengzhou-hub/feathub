...
class SparkTable(Table):
    ...
    def __init__(
        ...
        dataframe_builder: SparkDataFrameBuilder,
    ) -> None:
        """
        ...
        :param dataframe_builder: The builder to create Spark DataFrame from the
                                  feature.
        """
    ...
    def get_schema(self) -> Schema:
        return to_feathub_schema(self._dataframe_builder.build(self._feature).schema)
    ...
    def to_pandas(self, force_bounded: bool = False) -> pd.DataFrame:
        ...
        dataframe = self._dataframe_builder.build(feature)
    ...
    def __eq__(self, other: typing.Any) -> bool:
        return (
            ...
            and self._dataframe_builder == other._dataframe_builder
        )
