...
METRIC_STORE_REPORT_INTERVAL_CONFIG = METRIC_STORE_PREFIX + "report_interval"
METRIC_STORE_REPORT_INTERVAL_DOC = "The interval to report metrics."

METRIC_STORE_NAMESPACE_CONFIG = METRIC_STORE_PREFIX + "namespace"
METRIC_STORE_NAMESPACE_DOC = "The namespace of the metric store."


metric_store_config_defs = [
    ConfigDef(
    ...
    ConfigDef(
        name=METRIC_STORE_REPORT_INTERVAL_CONFIG,
        value_type=timedelta,
        description=METRIC_STORE_REPORT_INTERVAL_DOC,
        default_value=None,
        validator=gt(timedelta()),  # type: ignore
    ),
    ConfigDef(
