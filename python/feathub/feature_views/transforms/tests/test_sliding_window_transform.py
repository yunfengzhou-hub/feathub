    ...
    def test_transform_without_key(self):
        ...
        expected_results = [
            (
                ...
                pd.DataFrame(
                    [
                        [to_epoch_millis("2022-01-01 23:59:59.999"), 500, False],
                        [to_epoch_millis("2022-01-02 23:59:59.999"), 1000, False],
                        [to_epoch_millis("2022-01-03 23:59:59.999"), 1600, False],
                        [to_epoch_millis("2022-01-04 23:59:59.999"), 1100, False],
                        [to_epoch_millis("2022-01-05 23:59:59.999"), 0, True],
                    ],
                    columns=[
                        "window_time",
                        "total_cost",
                        "__is_empty_window__total_cost",
                    ],
                ),
            ),
            (
            ...
            (
                ...
                pd.DataFrame(
                    [
                        ...
                        ["Alex", to_epoch_millis("2022-01-06 23:59:59.999"), 0, True],
                        [
                            "Emma",
                            to_epoch_millis("2022-01-01 23:59:59.999"),
                            400,
                        ...
                        ["Emma", to_epoch_millis("2022-01-05 23:59:59.999"), 0, True],
                        [
                            "Jack",
                            to_epoch_millis("2022-01-03 23:59:59.999"),
                            500,
                        ...
                        ["Jack", to_epoch_millis("2022-01-06 23:59:59.999"), 0, True],
                    ],
                    columns=[
                        "name",
                        "window_time",
            ...
            (
                ...
                pd.DataFrame(
                    ...
                    columns=[
                        ...
                        "pay_count",
                        "__is_empty_window__last_2_minute_total_pay",
                        "__is_empty_window__pay_count",
                        "__is_empty_window__last_2_minute_total_receive",
                    ],
                ),
            ),
            (
            ...
            (
                ...
                pd.DataFrame(
                    ...
                    columns=[
                        ...
                        "cnt",
                        "avg_time_per_trip",
                        "__is_empty_window__first_time",
                        "__is_empty_window__last_time",
                        "__is_empty_window__cnt",
                    ],
                ),
            ),
            (
    ...
    def test_join_sliding_feature(self):
        ...
        expected_results = [
            (
                ...
                pd.DataFrame(
                    [
                        ["Alex", "2022-01-01 09:01:00", None, None, True, True],
                        ["Alex", "2022-01-01 09:02:00", 300.0, 2, False, False],
                        ["Alex", "2022-01-01 09:05:00", 0.0, 0, False, False],
                        ["Alex", "2022-01-01 09:07:00", 450.0, 1, False, False],
                        ["Alex", "2022-01-01 09:09:00", 0.0, 0, False, False],
                    ],
                    columns=[
                        "name",
                        "time",
                        ...
                        "cnt",
                        "__is_empty_window__last_2_minute_total_cost",
                        "__is_empty_window__cnt",
                    ],
                ),
            ),
            ...
            (
                ...
                pd.DataFrame(
                    ...
                    columns=[
                        ...
                        "cnt",
                        "__is_empty_window__last_2_minute_cost_value_counts",
                        "__is_empty_window__cnt",
                    ],
                ),
            ),
    ...
    def test_multiple_window_size_with_same_step(self):
        ...
        expected_result_df = pd.DataFrame(
            ...
            columns=[
                ...
                "__is_empty_window__total_cost_two_days",
                "__is_empty_window__avg_cost_three_days",
                "__is_empty_window__min_cost_two_days",
                "__is_empty_window__max_cost_two_days",
                "__is_empty_window__first_cost_two_days",
                "__is_empty_window__last_cost_two_days",
                "__is_empty_window__cost_count_two_days",
                "__is_empty_window__cost_value_counts_two_days",
            ],
        )
